...
3. `https://mei-chan-nel.github.io/info1-quiz-app/app/about.html`
4. `https://mei-chan-nel.github.io/info1-quiz-app/app/privacy.html`

新設した1と2には広告コードを置いていないが、将来サイト共通コードを変更した場合にも広告を出さない方針を保つため、除外設定にも登録する。3と4には既存アプリの広告コードがあるため、管理画面の完全一致除外が必須となる。
