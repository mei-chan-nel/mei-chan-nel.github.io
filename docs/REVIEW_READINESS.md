...
- 1,000問すべてを6分野に分類した。
- 36ページへ最大30問ずつ掲載し、正答・解説・出典・タグを読めるようにした。
- 別の一問一答330問を5分野・35ページに整理し、問題・答え・キーワードと対応動画333本を掲載した。書籍の解説本文は掲載していない。
- Kindle問題集4冊の控えめな案内ページを追加し、広告コードは置いていない。
...
- ポータル40ページと問題一覧37ページが、それぞれの公開URLで閲覧できる
- ポータルの案内・プライバシー・書籍案内3 URLの完全一致除外が管理画面で確認できる
