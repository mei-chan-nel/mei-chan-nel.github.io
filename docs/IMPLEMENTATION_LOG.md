...
- 原本Excelの5分野・330問から、問題・答え・キーワード・動画番号だけを公開用JSONへ抽出した。
...
- ポータルトップ、問題一覧トップ、36分野ページ、動画問題36ページ、既存アプリ本体を広告対象とした。
- ポータルの案内・プライバシー・書籍案内ページは広告コードなしとした。
...
- 両リポジトリのビルド記録から公開ページ一覧を読み、`mei-chan-nel.github.io/sitemap.xml` に両リポジトリの78 URLを収録する。
